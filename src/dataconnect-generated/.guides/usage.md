...
```ts
import { useSeedData, useListPublicMovies, useGetUserLists, useCreateList } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetUserLists(getUserListsVars);
...
```js
import { seedData, listPublicMovies, getUserLists, createList } from '@dataconnect/generated';
...
// Operation GetUserLists:  For variables, look at type GetUserListsVars in ../index.d.ts
